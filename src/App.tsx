...
const WhatsAppButton = () => {
  return (
    <motion.a 
      ...
      className="fixed bottom-10 right-8 z-[100] w-16 h-16 bg-[#25d366] rounded-full flex items-center justify-center whatsapp-shadow transition-transform"
    >
      <svg className="w-8 h-8 text-white fill-current" viewBox="0 0 24 24">
        <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.185-.573c.948.604 1.926.967 3.146.967 3.181 0 5.767-2.587 5.768-5.766.001-3.18-2.586-5.767-5.768-5.768zm3.393 8.166c-.191.54-.961.993-1.378 1.022-.387.03-.895.048-1.428-.109-.272-.081-.624-.199-1.077-.393-1.923-.823-3.167-2.774-3.262-2.902-.095-.129-.773-1.027-.773-1.956 0-.93.484-1.385.656-1.576.172-.191.373-.239.497-.239h.359c.123 0 .248.01.354.306.124.341.425.641.425.641.228.326.155.674.025.961-.061.124-.136.241-.219.336-.084.095-.173.197-.084.341.09.144.398.659.855 1.066.588.524 1.135.688 1.298.773.163.085.347.059.474-.038.127-.097.458-.535.58-.718.122-.183.353-.153.593-.058.24.096 1.488.701 1.488.701z" />
      </svg>
    </motion.a>
  );
};
